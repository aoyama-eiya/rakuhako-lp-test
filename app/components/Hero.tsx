...
export default function Hero() {
    return (
        <>
            ...
            <main className="relative min-h-[900px] lg:h-screen flex flex-col hero-gradient">
                    ...
                    <div className="max-w-[1440px] mx-auto px-12 w-full pt-32 pb-12">
                        <div className="grid lg:grid-cols-2 gap-16 items-center">
                            <div className="flex flex-col">
                                ...
                                <h1 className="text-[52px] font-black leading-[1.3] text-slate-900 tracking-tight mb-8 text-nowrap-custom">
                                    梱包の見積もり待ち、<br />
                            ...
                            <div className="relative lg:h-[580px] flex items-center justify-center">
                                <div className="relative w-full h-full max-w-[560px] aspect-[16/10] lg:aspect-auto rounded-[2.5rem] overflow-hidden shadow-2xl z-10 group">
                                    <img alt="Logistics professional at work" className="w-full h-full object-cover transition-transform duration-1000 group-hover:scale-105" src="/img/fa-sutobyu-detukatte.jpg" />
                                    <div className="absolute inset-0 bg-gradient-to-t from-slate-900/30 via-transparent to-transparent"></div>
                                </div>
                                <div className="absolute -bottom-12 -left-64 w-[850px] h-auto z-30 hidden lg:block filter drop-shadow-2xl">
                                ...
                                <div className="absolute bottom-0 right-0 w-32 h-32 bg-blue-400/10 rounded-full blur-2xl -z-10"></div>
                            </div>
                        </div>
                    </div>
                </div>
